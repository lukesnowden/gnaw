...
class Helpers extends SelectorGenerator implements Generator
{
    ...
    public function generate(): GnawFile
    {
        ...
        $this->mediarize( function( $prefix, $size ) use( &$content ) {
            ...
            $content .= ".{$prefix}sticky\:top { position: -webkit-sticky; position: sticky; left:0; right: 0; top: 0; }\n";
            $content .= ".{$prefix}sticky\:bottom { position: -webkit-sticky; position: sticky; left:0; right: 0; bottom: 0; }\n";
            ...
            $content .= ".{$prefix}text-transform\:uppercase { text-transform:uppercase; }\n";
            $content .= ".{$prefix}text-transform\:lowercase { text-transform:lowercase; }\n";
